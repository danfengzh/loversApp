...
public class JpushClientUtil {
    private final static String appKey = "4d454221295c35af705cc26e";

    private final static String masterSecret = "2cca1abd3a5704d17e5f8b6b";
    ...
    public static int sendDynatic(String alias,String tags,String notification_title, String msg_title, String msg_content, String extrasparam) {
        int result = 0;
        try {
            PushPayload pushPayload = JpushClientUtil.buildPushObject_android_and_iosWithTags(alias,tags,notification_title, msg_title, msg_content, extrasparam);
            System.out.println(pushPayload);
            PushResult pushResult = jPushClient.sendPush(pushPayload);
            System.out.println(pushResult);
            if (pushResult.getResponseCode() == 200) {
    ...
    public static PushPayload buildPushObject_android_and_iosWithTags(String alias,String tag,String notification_title, String msg_title, String msg_content, String extrasparam) {
        return PushPayload.newBuilder()
                .setPlatform(Platform.android_ios())
    ...
    public static int  sendAnaroidRegisters(String resID,String tilte,String msgContent){
        PushResult result = null;
        try {
            result = jPushClient.sendAndroidMessageWithRegistrationID(tilte, msgContent, resID);
        } catch (APIConnectionException e) {
            e.printStackTrace();
        } catch (APIRequestException e) {
            e.printStackTrace();
